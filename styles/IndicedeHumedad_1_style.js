...
var style_IndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.001077 && value <= 0.064994) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.064994 && value <= 0.131065) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.131065 && value <= 0.197135) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.197135 && value <= 0.263206) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.263206 && value <= 0.329277) {
            style = [ new ol.style.Style({
