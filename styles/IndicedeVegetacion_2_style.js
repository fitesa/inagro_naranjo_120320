...
var style_IndicedeVegetacion_2 = function(feature, resolution){
    ...
    if (value >= 0.191577 && value <= 0.290975) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.290975 && value <= 0.390373) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.390373 && value <= 0.489770) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.489770 && value <= 0.589168) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.589168 && value <= 0.688566) {
            style = [ new ol.style.Style({
